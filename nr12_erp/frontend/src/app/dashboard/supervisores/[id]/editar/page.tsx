...
export default function EditarSupervisorPage() {
  ...
  const handleResetPassword = async () => {
    ...
    try {
      ...
      const response = await fetch(`/api/proxy/supervisores/${id}/resetar_senha/`, {
        method: 'POST',
        headers: {
          ...
          <div className="bg-white rounded-xl shadow-xl max-w-md w-full">
            ...
            <div className="px-6 py-4 border-b border-gray-200">
              <h3 className="text-lg font-semibold text-gray-900">
                {username ? 'Resetar Senha do Supervisor' : 'Criar Acesso do Supervisor'}
              </h3>
            </div>
            ...
            <div className="px-6 py-4">
              ...
              {!username && (
                <p className="text-sm text-gray-600 mb-4">
                  O username será o CPF do supervisor (apenas números).
                </p>
              )}
              ...
              {resetPasswordResult?.sucesso && resetPasswordResult.senha && (
                <div className="mb-4 p-4 bg-green-50 border border-green-200 rounded-lg">
                  ...
                  <p className="text-xs text-green-800 mb-2">Copie e envie para o supervisor:</p>
              ...
              <div className="mb-4 p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
                <p className="text-xs text-yellow-800">
                  ⚠️ <strong>Atenção:</strong> {username
                    ? 'Esta ação irá alterar a senha do supervisor.'
                    : 'Esta ação criará um usuário para o supervisor acessar o sistema.'}
                  {' '}Certifique-se de comunicar as credenciais ao supervisor.
                </p>
              </div>
            </div>
